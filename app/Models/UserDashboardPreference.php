...
class UserDashboardPreference extends Model
{
    ...
    const ROLE_DEFAULTS = [
        ...
        'manager' => [
            ...
            ['id' => 'quick_actions', 'enabled' => true, 'position' => 10],
        ],
        'admin' => [
            ['id' => 'stat_cards', 'enabled' => true, 'position' => 0],
            ['id' => 'notifications', 'enabled' => true, 'position' => 1],
            ...
            ['id' => 'activity_feed', 'enabled' => true, 'position' => 9],
            ['id' => 'quick_actions', 'enabled' => true, 'position' => 10],
        ],
        'control_tower' => [
            ['id' => 'stat_cards', 'enabled' => true, 'position' => 0],
            ...
            ['id' => 'job_trend_chart', 'enabled' => true, 'position' => 5],
            ['id' => 'overdue_jobs', 'enabled' => true, 'position' => 6],
            ['id' => 'upcoming_pdi', 'enabled' => true, 'position' => 7],
            ['id' => 'towing_schedule', 'enabled' => true, 'position' => 8],
            ['id' => 'quick_actions', 'enabled' => true, 'position' => 9],
        ],
    ];

    ...
    <nav class="sidebar d-flex flex-column">
        ...
        <div class="flex-grow-1 overflow-auto">
            <ul class="nav flex-column">
                ...
                @auth
                @if(Auth::user()->canManageMasterData())
                <div class="nav-section">Import Data</div>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#masterDataSubmenu" data-bs-toggle="collapse" role="button" aria-expanded="{{ request()->routeIs('service-advisors.*') || request()->routeIs('foremen.*') ? 'true' : 'false' }}">
                        <i class="bi bi-database-fill"></i> Master Data
                        <i class="bi bi-chevron-down ms-auto" style="font-size: 0.8em;"></i>
                    </a>
                    <div class="collapse {{ request()->routeIs('service-advisors.*') || request()->routeIs('foremen.*') ? 'show' : '' }}" id="masterDataSubmenu">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('service-advisors.*') ? 'active' : '' }}" href="{{ route('service-advisors.index') }}">Service Advisors</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('foremen.*') ? 'active' : '' }}" href="{{ route('foremen.index') }}">Foremen</a>
                            </li>
                        </ul>
                    </div>
                </li>

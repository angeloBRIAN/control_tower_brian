...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('saveColumnsBtn').addEventListener('click', function() {
        ...
        fetch('{{ route("preferences.columns") }}', {
            ...
            if (res.status === 401) {
                alert('You have been logged out. Please refresh the page and log in again.');
                return { success: false };
            }
            if (!res.ok) {
            ...
            if (err.message === 'Failed to fetch') {
                alert('Network error: Unable to save preferences. Please check your internet connection and refresh the page.');
            } else {
